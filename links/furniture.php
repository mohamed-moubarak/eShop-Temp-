...
?>
	        	...
	        	<h3 class="dark-grey col-md-offset-1">Furniture</h3> 
	        	<div class="table-responsive page-header col-md-offset-1">          
 					<table class="table">
					    <tbody>
							...
							<!-- Products List Start -->
<?php
$results = $mysqli->query("SELECT PID  , name as product_name, picture_url as product_img_name , stock,  price FROM products WHERE products.category = 'furniture'");
if($results){ 
$products_item = '';
